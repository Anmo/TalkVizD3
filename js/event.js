 ...
 */
 ...
 InkEvent.on = bean.on;
 InkEvent.add = bean.add;
 InkEvent.one = bean.one;
 InkEvent.off = bean.off;
 InkEvent.remove = bean.remove;
 InkEvent.clone = bean.clone;
 InkEvent.fire = bean.fire;
 InkEvent.Event = bean.Event;
 InkEvent.setSelectorEngine = bean.setSelectorEngine;
 InkEvent.noConflict = bean.noConflict;
